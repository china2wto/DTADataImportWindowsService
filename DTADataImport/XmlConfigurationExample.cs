...
namespace DTADataImport
{
    ...
    {
        static string szCurrent = new FileInfo(typeof(XmlConfigurationExample).Assembly.Location).DirectoryName;
        public string Name
        {
        ...
        public void Run()
        {
            ...
            properties["quartz.plugin.xml.fileNames"] = szCurrent+ "/quartz_jobs.xml";
            ...
            while(true){
                //log.Info("-------wait 1 hour .--------");
                Thread.Sleep(60*60 * 1000);//1 hour.
            }
            //try
            //{
            //    Thread.Sleep(24*24*60*60*1000);//24 days
            //}
